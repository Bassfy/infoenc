...
| community · career · full labs orchestration · Stripe/PayPal adapters | 🔩 scaffolded | Schema (Phase 3) + module boundaries + event taxonomy in place; services build out next, each following the Phase 5 module anatomy and inheriting the security checklist. |
