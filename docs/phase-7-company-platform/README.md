...
| **CRM — Account 360 + flywheel** | ✅ | One view of an org across BOTH platforms (subscription, seats, engagements, open findings by severity, invoices, tickets) with **cross-sell detection** — the assess↔train flywheel (doc 03 §4): a services client with open findings + no training → corporate-Academy lead; a training customer with no engagement → assessment lead. Detector pure + verified. |
